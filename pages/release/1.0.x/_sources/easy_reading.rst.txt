...
- **Artifact columns:** They represent the content of the artifacts stored using the method :samp:`log_artifacts` or :samp:`log_checkpoint` and which are stored in the :samp:`artifacts` directory. 
